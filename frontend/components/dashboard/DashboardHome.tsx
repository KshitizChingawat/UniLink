      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card>
          ...
          <CardContent className="space-y-4">
            <Button className="w-full justify-start" variant="outline" onClick={() => navigate('/dashboard/files')}>
              <Send className="w-4 h-4 mr-2" />
              Send File to Device
            </Button>
            <Button className="w-full justify-start" variant="outline" onClick={() => navigate('/dashboard/clipboard')}>
              <Clipboard className="w-4 h-4 mr-2" />
              Sync Clipboard
            </Button>
            <Button className="w-full justify-start" variant="outline" onClick={() => navigate('/dashboard/devices')}>
