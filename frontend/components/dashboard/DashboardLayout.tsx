...
const DashboardLayout = ({ children }: DashboardLayoutProps) => {
  ...
  return (
    <div className="dashboard-shell min-h-screen bg-gray-50 dark:bg-slate-950 flex transition-colors duration-300">
      ...
      {/* Sidebar */}
      <div className={`
        dashboard-sidebar fixed inset-y-0 left-0 z-50 w-64 bg-white dark:bg-slate-950 shadow-lg transform transition-transform duration-300 ease-in-out lg:sticky lg:top-0 lg:h-screen lg:flex-shrink-0 lg:translate-x-0
      ...
      `}>
        <div className="flex flex-col h-full">
          ...
          {/* Footer */}
          <div className="dashboard-border shrink-0 border-t bg-white/95 p-4 backdrop-blur dark:bg-slate-950/95">
      ...
      {/* Main content */}
      <div className="dashboard-main min-w-0 flex-1 lg:ml-0">
        {/* Mobile header */}
