...
const DemoVideo = ({ className = 'border-unilink-600 bg-white text-unilink-600 hover:bg-unilink-50 dark:border-slate-600 dark:bg-slate-900 dark:text-slate-100 dark:hover:bg-slate-800' }: DemoVideoProps) => {
  ...
  return (
    <>
      ...
      <Button
        ...
        variant="outline"
        size="lg"
        className={`px-8 py-4 text-lg ${className}`}
      >
