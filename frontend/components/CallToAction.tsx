...
const CallToAction = () => {
  return (
    <section className="py-24 bg-gradient-to-r from-unilink-600 via-blue-600 to-purple-600 relative overflow-hidden dark:from-slate-900 dark:via-slate-900 dark:to-slate-950">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
            ...
            <DemoVideo className="border-white text-white hover:bg-white hover:text-unilink-600" />
          </div>
